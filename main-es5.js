...
var AddTextComponent = /** @class */ (function () {
    function AddTextComponent() {
        this.addTextData = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.tempPlaceHolder = "Add...";
        this.addText = "Submit";
    }
    AddTextComponent.prototype.ngOnInit = function () {
    };
    AddTextComponent.prototype.onSubmit = function () {
...
var ExperienceObjComponent = /** @class */ (function () {
    ...
    ExperienceObjComponent.prototype.ngOnInit = function () {
    };
    //Create the ExpObj description and save it as json
    ExperienceObjComponent.prototype.createExp = function (theText) {
    ...
    ExperienceObjComponent.ctorParameters = function () { return [
...
var MultiLineToJsonComponent = /** @class */ (function () {
    function MultiLineToJsonComponent() {
        this.createText = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.title = "";
        this.cssClass = "";
    }
    MultiLineToJsonComponent.prototype.ngOnInit = function () {
    };
    MultiLineToJsonComponent.prototype.generateText = function () {
...
var FlipGameComponent = /** @class */ (function () {
    ...
    FlipGameComponent.prototype.ngOnInit = function () {
    ...
    FlipGameComponent.prototype.onPreset = function (id) {
        switch (id) {
            case 0:
    ...
    FlipGameComponent.prototype.loadImgs = function (imgs) {
        this.loadedImgs = imgs;
    };
    //Get the img src to display
    FlipGameComponent.prototype.getDisplay = function (img) {
        if (img.src != null) {
            return img.src;
        }
        return "";
    ...
    FlipGameComponent.prototype.getCss = function (img) {
        return img.css;
    };
    //On Selected imgs
    FlipGameComponent.prototype.onChange = function (event) {
        var _this = this;
        ...
        var _loop_1 = function (i) {
            ...
            reader.onload = function () { return _this.addToUsers(reader.result); };
    ...
    FlipGameComponent.prototype.addToUsers = function (data) {
        this.usersImgs.push({ css: "fileSize", src: data, id: 0 });
    };
    //Called to increase or decrease the difficulty
    FlipGameComponent.prototype.increaseLevel = function (more) {
        if (more) {
    ...
    FlipGameComponent.prototype.createGrid = function () {
    ...
    FlipGameComponent.prototype.onSelect = function (img) {
        var _this = this;
        ...
        if (this.selectedImgs[0] != -1 && this.selectedImgs[1] != -1) {
            setTimeout(function () {
                //Check if selected
                if (_this.curGameImgs[_this.selectedImgs[0]] === _this.curGameImgs[_this.selectedImgs[1]]) {
                    //couple was completed
                    _this.wins++;
                    //add to already finished
                    _this.usedIndex.push(_this.gameImgs[_this.selectedImgs[0]].id);
                    _this.usedIndex.push(_this.gameImgs[_this.selectedImgs[1]].id);
                    //when all couples was found
                    if (_this.wins >= (_this.curGameImgs.length / 2)) {
                        _this.onWin();
                    }
                }
                else {
                    //Reset to default data
                    _this.gameImgs[_this.selectedImgs[0]].css = _this.defaultcss;
                    _this.gameImgs[_this.selectedImgs[0]].src = _this.defaultImg;
                    //Reset to default data
                    _this.gameImgs[_this.selectedImgs[1]].css = _this.defaultcss;
                    _this.gameImgs[_this.selectedImgs[1]].src = _this.defaultImg;
                }
                //Reset to non selected
                _this.selectedImgs[0] = -1;
                _this.selectedImgs[1] = -1;
            }, 200);
        }
    };
    //When finish the game
    FlipGameComponent.prototype.onWin = function () {
        this.showOutput("Congratulations you won!!!");
        this.startText = "New Game!";
    };
    //On Start Game 
    FlipGameComponent.prototype.onStartPress = function () {
        if (this.inGame) {
            this.inGame = false;
            this.resetGame();
            return;
    ...
    FlipGameComponent.prototype.resetGame = function () {
        this.showGameObjs(!this.inGame);
        this.startText = "Start Game!";
        this.createGrid();
    };
    //Generate what images will be in the game
    FlipGameComponent.prototype.generateRandomImgs = function () {
        var imgIndex = 0;
        var curTotal = 0;
    ...
    FlipGameComponent.prototype.showOutput = function (text) {
        this.displayText = text;
    };
    //Show or hide objects that has to do with the game
    FlipGameComponent.prototype.showGameObjs = function (show) {
        if (show) {
...
var ExpObjDisplayComponent = /** @class */ (function () {
    ...
    ExpObjDisplayComponent.prototype.ngOnInit = function () {
...
var ImagesGridDisplayComponent = /** @class */ (function () {
    ...
    ImagesGridDisplayComponent.prototype.ngOnInit = function () {
    };
    //shows or hides all images on the grid
    ImagesGridDisplayComponent.prototype.ShowCurImages = function (show) {
        var _this = this;
        this.curImages.forEach(function (img) {
            _this.ShowComponent(img, show);
        });
    };
    //Set the src of the object to default
    ImagesGridDisplayComponent.prototype.SetSrcToDefault = function (index) {
        this.curImages[index].src = this.defaultSrc;
    };
    //controls the visibility of the given component
    ImagesGridDisplayComponent.prototype.ShowComponent = function (img, show) {
        if (show) {
    ...
    ImagesGridDisplayComponent.prototype.SetSrcTo = function (index, src) {
        this.curImages[index].src = src;
    };
    ImagesGridDisplayComponent.prototype.onSelect = function (img) {
        this.onSelected.emit(img);
    };
    ImagesGridDisplayComponent.prototype.getDisplay = function (img) {
        return img.src;
    };
    ImagesGridDisplayComponent.prototype.getCss = function (img) {
        return img.css;
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
...
var InputAreaComponent = /** @class */ (function () {
    ...
    InputAreaComponent.prototype.onDelete = function () {
        //this would send the content of the input field only if there is a text
        if (this.text) {
...
var NavControlComponent = /** @class */ (function () {
...
var ResumeIntroComponent = /** @class */ (function () {
    function ResumeIntroComponent(resumeData) {
        this.resumeData = resumeData;
    }
    ResumeIntroComponent.prototype.ngOnInit = function () {
        this.contactMedia = this.resumeData.getMediaData();
    };
    ResumeIntroComponent.ctorParameters = function () { return [
        { type: src_app_services_Data_resume_data_service__WEBPACK_IMPORTED_MODULE_2__["ResumeDataService"] }
    ]; };
...
var TextToJsonComponent = /** @class */ (function () {
    function TextToJsonComponent(downloadTool) {
        this.downloadTool = downloadTool;
    }
    TextToJsonComponent.prototype.ngOnInit = function () {
    ...
    TextToJsonComponent.prototype.addData = function (theText) {
        this.myText.push(theText);
    };
    TextToJsonComponent.prototype.deleteTextData = function (theText) {
        this.myText = this.myText.filter(function (t) { return t !== theText; });
    };
    TextToJsonComponent.prototype.createJson = function (fileName) {
        if (this.myText != null && this.myText.length > 0) {
            this.downloadTool.DownloadTextToFileAsJson(this.myText, fileName);
        }
    };
    TextToJsonComponent.ctorParameters = function () { return [
...
var DownloadToolService = /** @class */ (function () {
    function DownloadToolService() {
        this.a = document.createElement('a');
    }
    DownloadToolService.prototype.DownloadTextToFileAsJson = function (theText, fileName) {
        if (theText == null) {
            console.log("No Data");
            return;
        }
...
var ExpObjModule = /** @class */ (function () {
    function ExpObjModule() {
    }
...
var ResumeDataService = /** @class */ (function () {
    ...
    //Get the Skills
    ResumeDataService.prototype.getSkills = function () {
        return this.skills;
    };
    //Get Experience
    ResumeDataService.prototype.getExperience = function () {
    ...
    ResumeDataService.prototype.getExpObjWithName = function (expName) {
        var _this = this;
        this.jsonLoader.getExpObjs(expName).subscribe(function (data) {
            _this.allExpObjs.push(data);
        });
    };
    //Get Media data from local data
    ResumeDataService.prototype.getMediaData = function () {
        return this.contactMedia;
    };
    //get education and summery text from local data
    ResumeDataService.prototype.getSummeryAndEducationText = function () {
        return this.summeryAndEducation;
    };
    ResumeDataService.ctorParameters = function () { return [
...
var JsonLoaderService = /** @class */ (function () {
    ...
    JsonLoaderService.prototype.getExpObjs = function (jsonName) {
        var thePath = this.jsonsPath + jsonName;
        return this.http.get(thePath);
    };
    JsonLoaderService.ctorParameters = function () { return [
